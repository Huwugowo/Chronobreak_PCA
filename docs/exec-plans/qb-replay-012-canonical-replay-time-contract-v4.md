...
`docs/exec-plans/qb-replay-012-canonical-replay-time-contract-v3.md`. That reviewed
draft, v2 draft, and the original
`docs/exec-plans/qb-replay-012-canonical-replay-time-contract.md` remain unchanged as
planning history. This plan is self-contained: predecessor plans are
