    ...
    fn telemetry() -> NativeSessionTelemetrySnapshot {
        NativeSessionTelemetrySnapshot {
            ...
            conversion: NativeNv12TelemetrySnapshot {
                ...
                no_free_slot_admission_failures: 0,
            ...
            mux: NativeMuxTelemetrySnapshot {
                ...
                video_writer_calls: 120,
                video_writer_duration_100ns: 1_200,
                maximum_video_writer_duration_100ns: 10,
                slow_video_writer_calls: 0,
                explicit_flush_calls: 1,
                explicit_flush_duration_100ns: 10,
                maximum_explicit_flush_duration_100ns: 10,
